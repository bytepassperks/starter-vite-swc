  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-500 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-red-500/20 text-red-400 shadow-sm hover:bg-red-500/30 border border-red-500/30",
        outline:
          "border border-white/10 bg-transparent shadow-sm hover:bg-white/5 text-gray-300 hover:text-white",
        secondary:
          "bg-white/10 text-gray-300 shadow-sm hover:bg-white/20",
